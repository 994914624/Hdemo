...
public class App extends Application {
    ...
    final static String SA_SERVER_URL_DEBUG = "https://sdk-test.datasink.sensorsdata.cn/sa?project=YangYang&token=95c73ae661f85aa0";

    // release 模式的数据接收地址（发版，正式项目）
    final static String SA_SERVER_URL_RELEASE = "https://sdk-test.datasink.sensorsdata.cn/sa?project=YangYang&token=95c73ae661f85aa0";
